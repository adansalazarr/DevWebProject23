...
function showQuestion(preguntasLista, indice) {
    ...
    if (indice < preguntasLista.length) {
		...
		<h4 >Resultados</h4>
		<p class="text-center">${
			(puntuacion_final == puntuacion_maximo) ? `Muy bien! Mantienes una buena estabilidad emocional! De acuerdo con tus respuestas, es probable que no tengas un problema de depresión.` : 
